...
public class Main_Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (acct != null) {
            ...
            if (personEmail.contains("akshaywairagade2@gmail.com")){
                Intent intent=new Intent(Main_Menu.this,Chef_Activity.class);
                startActivity(intent);
                finish();
            }
            else if (!personEmail.contains("@iitbhilai.ac.in")){
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    alertDialogue.setTitle("Confirmation")
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Toast.makeText(Main_Menu.this,"Order placed for "+dish_name,Toast.LENGTH_SHORT).show();
